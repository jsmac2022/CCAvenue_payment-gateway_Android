...
//	public static final String rsaKeyUrl="https://secure.ccavenue.com/transaction/jsp/GetRSA.jsp"; //this is test url you can modify with your on url
	...
	public static final String redirectUrl="https://schoolforme.in:5000/api/common/ccavRequestHandler:{{#formdata}}"; //this is test url you can modify with your on url, you can use php or jsp,
	public static final String cancelUrl="https://schoolforme.in:5000/api/common/ccavRequestHandler:{{#formdata}}";//this is test url you can modify with your on url
	public static final String rsaKeyUrl="https://secure.ccavenue.com/transaction/jsp/GetRSA.jsp"; //this is test url you can modify with your on url
